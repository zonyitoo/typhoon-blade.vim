...
syn keyword bladeTarget cc_binary cc_library cc_plugin cc_test gen_rule lex_yacc_library  enable_if
syn keyword bladeTarget proto_library java_jar resource_library swig_library

syn keyword bladeArg always_run cmd defs deprecated deps dynamic_link exclusive
syn keyword bladeArg extra_cppflags incs link_all_symbols name outs outs
syn keyword bladeArg prebuilt srcs testdata warning
...
let b:current_syntax = "typhoon-blade"
